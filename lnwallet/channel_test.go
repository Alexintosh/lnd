...
func TestAddHTLCNegativeBalance(t *testing.T) {
	...
	// We'll then craft another HTLC with 1 BTC to add to Alice's channel.
	// This attempt should put Alice in the negative (since the fee for
	// adding this HTLC is also considered), meaning she should reject
	// the HTLC.
...
func TestMaxAcceptedHTLCs(t *testing.T) {
	...
	// After receiving the next HTLC, next state transitino should fail
